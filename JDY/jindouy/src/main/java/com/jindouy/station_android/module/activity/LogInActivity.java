...
import com.jindouy.station_android.module.bean.LogInBean;
...
import static com.jindouy.station_android.R.id.et_phone;
import static com.jindouy.station_android.R.id.et_psw;
...
//                    Log.e("TAG",deviceToken+"设备token+++++++++++++++++++++++");
    ...
    private void explainJson(String json) {
        ...
        if (status.equals("0")) {//登陆失败
            Toast.makeText(LogInActivity.this, logInBean.getInfo().getMsg(), Toast.LENGTH_SHORT).show();
