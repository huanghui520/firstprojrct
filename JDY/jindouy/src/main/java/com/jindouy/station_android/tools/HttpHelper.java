...
public class HttpHelper {
    ...
    private static final String BASE_URL = "http://139.224.190.235/index.php?m=Sapi";//线上
//    private static final String BASE_URL = "http://192.168.0.155/index.php?m=Sapi";//线下
