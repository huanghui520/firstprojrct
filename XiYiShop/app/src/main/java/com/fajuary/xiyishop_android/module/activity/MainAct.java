...
import com.fajuary.xiyishop_android.module.bean.PosJiaoYiBean;
import com.fajuary.xiyishop_android.module.bean.PosYLBean;
import com.fajuary.xiyishop_android.module.bean.PosZhiFuBean;
...
import com.fajuary.xiyishop_android.tools.Utils;
...
public class MainAct extends BaseActivity implements OnItemSelectedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityManager.getInstance().pushActivity(MainAct.this);
        setContentView(R.layout.main);
        // 建立服务连接
        bindServicea();
        shopName = CacheUtils.getstr(this, "shopName");
        orderSpareId = CacheUtils.getstr(this, "orderSpareId");
...
//                            resTv.setText(str);
                                    ...
                                    if (re_code == 0) {
                                        ...
                                        XYApi.possend(token, orderSpareId, out_trade_no, type,new AsyncHttpResponseHandler() {
                                            @Override
                                    ...
                                    if (RET_SUCCESS.equalsIgnoreCase(retCode)) {
                                        ...
                                        runOnUiThread(new Runnable() {
                                            ...
                                            public void run() {
                                                ...
                                                XYApi.possend(token, orderSpareId, voucherNo,type, new AsyncHttpResponseHandler() {
                                                    @Override
                                                    public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                                                        if (null != responseBody && responseBody.length > 0) {
                                                            Log.e("TAG", new String(responseBody) + "返回的数据" + "============================");
